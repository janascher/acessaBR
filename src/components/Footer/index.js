            ...
            <div className="footer__section footer__section--second">
                <div className="footer__container">
                    <p>
                        ...
                        <small>Projetado por <a href="https://github.com/cavalcantemmarcelo" target="_blank">Marcelo Cavalcante</a> e <a href="https://github.com/mja-maia" target="_blank">Miguel Maia</a>, desenvolvido por <a href="https://github.com/janascher" target="_blank">Janaína Scher, Aluno EBAC</a>.</small> 
                    </p>
                    <a href="#top" className="button">
                        <img src={iconTop} alt="Voltar ao topo da página"/>
                    </a>
                </div>
            </div>
        </footer>
